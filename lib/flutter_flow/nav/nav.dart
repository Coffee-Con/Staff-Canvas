...
class AppStateNotifier extends ChangeNotifier {
  ...
  StaffCanvasAuthUser? initialUser;
  StaffCanvasAuthUser? user;
  ...
  void update(StaffCanvasAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'SendSuccess',
          path: '/sendSuccess',
          builder: (context, params) => SendSuccessWidget(),
        ),
        FFRoute(
          name: 'Assignments',
          path: '/assignments',
        ...
        FFRoute(
          name: 'RewardConfirm',
          path: '/rewardconfirm',
          builder: (context, params) => RewardConfirmWidget(
            rewardID: params.getParam(
              'rewardID',
              ParamType.int,
            ),
            rewardPoint: params.getParam(
              'rewardPoint',
              ParamType.int,
            ),
          ),
