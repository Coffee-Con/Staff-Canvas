...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    staffCanvasAuthUserSubject.add(
      StaffCanvasAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<StaffCanvasAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  StaffCanvasAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = StaffCanvasAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    staffCanvasAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
StaffCanvasAuthUser? currentUser;
